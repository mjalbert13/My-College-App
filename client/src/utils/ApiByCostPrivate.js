...
const SEARCH = "&&_fields=id,school.name,school.state,latest.student.size,latest.cost.avg_net_price.private,latest.cost.avg_net_price.public,school.school_url&_per_page=100&sort=latest.cost.avg_net_price.public:desc";
